...
export type PackageType = "standard" | "super" | "advanced";
...
export function ListingPackages({ selectedPackage, onChange }: ListingPackagesProps) {
    return (
                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <div className={cn("text-xl font-bold", pkg.color)}>{pkg.price}</div>
                        </div>
